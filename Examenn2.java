        ...
        do {
            ...
            switch (option) {
                ...
                case 3:
                    ...
                    for (int i = 0; i < num_prods; i++) {
                        if (names[i].equalsIgnoreCase(name_detail)) {
                            ...
                            System.out.println("Precio: " + prices[i] + " en BS, en divisas: " 
                ...
                case 5:
                    ...
                    double total = 0.0, net_total = 0.0, gross_total = 0; 
                    ...
                    System.out.println("Monto total de precios más IVA: " + decimal.format(net_total));
                    System.out.println("Monto total de precios sin IVA: " + decimal.format(gross_total));
